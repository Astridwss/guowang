...
from schemas.request_models import TaskSubmitRequest
from schemas.response_models import TaskSubmitResponse, TaskStatusResponse
...
async def submit_rag_task(request: TaskSubmitRequest, background_tasks: BackgroundTasks):
...
@router.get("", response_model=TaskStatusResponse)
